      ...
      <section className="section">
        <div className="container">
          <SectionBumper
            ...
            sub="Most of my work falls into one of these three areas — and the useful part is that they overlap."
          />
      ...
      <section className="section section--alt">
        <div className="container">
          <SectionBumper
            ...
            sub="Grouped by what they are for, rather than one long list."
          />
